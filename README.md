...
O projeto foi desenvolvido como parte das atividades obrigatórias do **Período 2 (Redes Neurais)** do programa de **Trainee CIS 2026** do [IEEE Student Branch - Universidade de Brasília (UnB)](https://ieee.unb.br/).
